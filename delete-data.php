    ...
    <div class="container">
        ...
        <div>
            ...
            <form method="POST" action="php/delete-data.php">
                ...
                <div>
                    <input type="submit" name="submit" value="Slett klass(er)" onclick="return checkDelete()"Delete"> 
                </div>
            </form>
            ...
            <form method="POST" action="php/delete-data.php">
                ...
                <div>
                    <input type="submit" name="submit" value="Slett student(er)" onclick="return checkDelete()"Delete">  
